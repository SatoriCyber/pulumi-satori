...
export class RequestAccessRule extends pulumi.CustomResource {
    ...
    /**
     * Identities of Satori users/IdP groups that will be set as access rule approvers. Once an access rule approver is defined, it is the ONLY entity that can approve the request generated from this access rule
     */
    ...
    constructor(name: string, argsOrState?: RequestAccessRuleArgs | RequestAccessRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RequestAccessRule.__pulumiType, name, resourceInputs, opts);
    }
}
